...
description: Search and fetch metadata from Polish academic and open research-data repositories -- Biblioteka Nauki, RCIN, RUJ (Jagiellonian University), AGH, AMU (Adam Mickiewicz University), UAFM, ICM Open, RODBuK, RePOD, Depot CeON, PPM (Polska Platforma Medyczna) and EMIS/ELibM. Covers articles, books, chapters, theses, dissertations and research datasets. IMPORTANT -- for any broad topic search, run `scripts/search_all.py --query X` first; it queries every searchable repository in parallel so results are never limited to one source. Use for Polish university repositories, "polskie repozytoria naukowe", "publikacje naukowe", "prace naukowe", "rozprawy doktorskie", "prace dyplomowe", "dane badawcze", "repozytorium uczelniane", DSpace, OAI-PMH or Dataverse lookups, or whenever the user names one of the repositories above. No API keys needed.
license: MIT
compatibility: Requires Python 3.9+ (standard library only, nothing to install) and outbound HTTPS access to bibliotekanauki.pl, rcin.org.pl, ruj.uj.edu.pl, api.repo.agh.edu.pl, repozytorium.amu.edu.pl, repozytorium.uafm.edu.pl, open.icm.edu.pl, rodbuk.pl, repod.icm.edu.pl, depot.ceon.pl, ppm.edu.pl, emis.icm.edu.pl.
---
...
- Every `scripts/...` path in this file is relative to **this skill's own
  ...
  `python3 /path/to/polish-academic-repositories/scripts/search_all.py --query "..."`, or `cd` into the skill
  folder first.
...
- The scripts need internet access to `bibliotekanauki.pl`, `rcin.org.pl`, `ruj.uj.edu.pl`, `api.repo.agh.edu.pl`, `repozytorium.amu.edu.pl`, `repozytorium.uafm.edu.pl`, `open.icm.edu.pl`, `rodbuk.pl`, `repod.icm.edu.pl`, `depot.ceon.pl`, `ppm.edu.pl`, `emis.icm.edu.pl`. If every call fails with a
